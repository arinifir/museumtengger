    ...
    <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
            <div class="col-md-9 ftco-animate pb-5 text-center">
                <h1 class="mb-3 bread">Detail Information</h1>
                <p class="breadcrumbs"><span class="mr-2"><a href="<?= base_url('Home'); ?>">Home <i class="ion-ios-arrow-forward"></i></a></span> <span class="mr-2"><a href="<?= base_url('Home/information'); ?>">Information</h1> <i class="ion-ios-arrow-forward"></i></a></span> <span>Detail <i class="ion-ios-arrow-forward"></i></span></p>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 ftco-animate">
                ...
                <h2 class="mb-3"><?= $info['title_artikel']; ?></h2>
                <i>
                    <p class="time-collection">Updated on <?= date("F d, Y", $info['waktu_artikel']) . ' at ' . date("H:i", $info['waktu_artikel']) ?></p>
                </i>
                <div class="ckeditorimg">
                    <?= $info['content_artikel']; ?>
                </div>

                <div class="mt-5">
                    <div class="comment-form-wrap ">
                        <h3 class="mb-4">Leave a comment</h3>
                        <form action="<?= base_url('Home/addcomment/' . $info['id_artikel']) ?>" class="p-5 bg-light" id="comment-form" method="post">
