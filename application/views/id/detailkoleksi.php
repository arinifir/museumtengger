    ...
    <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
            <div class="col-md-9 ftco-animate pb-5 text-center">
                <h1 class="mb-3 bread">Detail Koleksi</h1>
                <p class="breadcrumbs"><span class="mr-2"><a href="<?= base_url('Beranda'); ?>">Beranda <i class="ion-ios-arrow-forward"></i></a></span> <span class="mr-2"><a href="<?= base_url('Beranda/koleksi'); ?>">Koleksi <i class="ion-ios-arrow-forward"></i></a></span> <span>Detail <i class="ion-ios-arrow-forward"></i></span></p>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 ftco-animate">
                ...
                <h2 class="mb-3"><?= $collect['nama_koleksi']; ?></h2>
                <i>
                    <p class="time-collection">Diperbarui pada <?= date("d", $collect['waktu_koleksi']) . ' ' . convertTimestampToBulan($collect['waktu_koleksi']) . ' ' . date("Y", $collect['waktu_koleksi']) . ' Pukul ' . date("H:i", $collect['waktu_koleksi']) ?></p>
                </i>
                <div class="ckeditorimg">
                    <?= $collect['desk_koleksi']; ?>
                </div>

                <div class="mt-5">
                    <div class="comment-form-wrap ">
                        <h3 class="mb-4">Tinggalkan Komentar</h3>
                        <form action="<?= base_url('Beranda/addcomment/' . $collect['kd_koleksi']) ?>" class="p-5 bg-light" id="comment-form" method="post">
                    ...
                    <?php foreach ($info as $in) { ?>
                        <div class="block-21 mb-4 d-flex">
                            ...
                            <div class="text">
                                ...
                                <div class="meta">
                                    <div><a href="<?= base_url('Beranda/detail_informasi/' . $in['link_artikel']) ?>"><span class="icon-calendar"></span> Diperbarui pada <?= date("d", $in['waktu_artikel']) . ' ' . convertTimestampToBulan($in['waktu_artikel']) . ' ' . date("Y", $in['waktu_artikel']) ?></a></div>
